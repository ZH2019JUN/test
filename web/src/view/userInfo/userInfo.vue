  ...
  <div>
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="学院">
          <el-input v-model="searchInfo.xy" placeholder="搜索条件" />
        </el-form-item>
        <el-form-item>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="center" label="学院" prop="xy" width="170" />
        <el-table-column align="center" label="平均绩点成绩" prop="pjjdcj" width="80" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" label-width="80px">
        ...
        <el-form-item label="学籍状态:">
          <el-input v-model="formData.xjzt" clearable placeholder="请输入" />
        </el-form-item>
        <el-form-item label="平均绩点成绩:">
          <el-input v-model="formData.pjjdcj" clearable placeholder="请输入" />
        </el-form-item>
      </el-form>
      <template #footer>
